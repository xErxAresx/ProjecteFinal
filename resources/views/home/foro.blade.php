            ...
            <div class="col-md-auto">
                <h2>Temas Actuales</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td >
                            <a class="linkTema" id="{{'tema'.$tema->id}}" href={{url('/foro/mostrar/'.$tema->id)}} >{{$tema->titulo}}</a>
                            </td>
                            <td colspan="3">
                                {{$tema->texto}}
                            ...
                            <td>
                            <a class="linkUser" id="user{{$tema->user->id}}" href={{url('/foro/perfil/'.$tema->user_id)}}> {{$tema->user->nombreUsuario}}</a> / {{$tema->fecha}}
                            </td>
                        </tr>
                        @endforeach
